...
def main(folder, output, width, init_height,shuffle):
    #costume args object to hold the args:
    class Args:
        def __init__(self,folder, output, width, init_height,shuffle):
            self.folder = folder
            self.output = output
            self.width = width
            self.init_height = init_height
            self.shuffle  = shuffle
    args = Args(folder, output, width, init_height,shuffle)

    # this section comment by EG
    ...
    # # modify to allow call function with arguments
